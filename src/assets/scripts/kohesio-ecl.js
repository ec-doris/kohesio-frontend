...
var ECL = function(e, t) {
    ...
    var a = ["root"]
      , s = function() {
        ...
        i.autoInit = function(e, t) {
            t = (void 0 === t ? {} : t).ACCORDION,
            t = new i(e,void 0 === t ? {} : t);
            return t.init(),
            e.ECLAccordion = t
        }
        ;
        ...
        e.handleClickOnToggle = function(e) {
            ...
            !n || (t = r("use", n)) && (n = t.getAttribute("xlink:href"),
            s = "",
            s = i ? n.replace("minus", "plus") : n.replace("plus", "minus"),
            t.setAttribute("xlink:href", s));
            var s = r(".ecl-accordion__toggle-label", e);
            return s && (s.textContent = i ? e.getAttribute(this.labelCollapsed) : e.getAttribute(this.labelExpanded)),
            this
        }
        ,
        i
      ...
      , l = function() {
        ...
        return e.init = function() {
            ...
            this.slidesContainer && (this.slidesContainer.onmousedown = this.dragStart,
        ...
        e.destroy = function() {
            ...
            this.slidesContainer && (this.slidesContainer.removeEventListener("touchstart", this.dragStart),
        ...
        e.dragStart = function(e) {
            ...
            "touchstart" === e.type ? this.posX1 = e.touches[0].clientX : (this.posX1 = e.clientX,
            document.onmouseup = this.dragEnd,
            document.onmousemove = this.dragAction)
        }
        ,
        e.dragAction = function(e) {
            "touchmove" === (e = e || window.event).type ? (this.posX2 = this.posX1 - e.touches[0].clientX,
            this.posX1 = e.touches[0].clientX) : (this.posX2 = this.posX1 - e.clientX,
        ...
        e.dragEnd = function() {
            ...
            this.posFinal - this.posInitial < -this.threshold ? this.shiftSlide("next", !0) : this.posFinal - this.posInitial > this.threshold ? this.shiftSlide("prev", !0) : this.slidesContainer.style.left = this.posInitial + "px",
            document.onmouseup = null,
            document.onmousemove = null
        }
        ,
        e.shiftSlide = function(e, t) {
            this.allowShift && (this.index = "number" == typeof e ? e : "next" === e ? this.index + 1 : this.index - 1,
            this.moveSlides(!0)),
            t && this.autoPlay && this.handleClickOnToggle(),
            this.allowShift = !1
        }
        ,
        ...
        e.checkIndex = function() {
            ...
            this.slides && this.slides.forEach(function(e, t) {
        ...
        e.handleClickOnToggle = function() {
            var e = this
              ...
              , n = ""
              , n = this.autoPlay ? (clearInterval(this.autoPlayInterval),
            this.autoPlay = !1,
            i.replace("pause", "play")) : (this.autoPlayInterval = setInterval(function() {
                e.shiftSlide("next")
            }, 5e3),
            this.autoPlay = !0,
        ...
        e.handleResize = function() {
            return this.resizeTicker(),
            this.autoPlay && this.handleClickOnToggle(),
            this
        }
        ,
        i
    ...
    var v = c(function(e, t) {
            ...
            e.exports = function(moment) {
                var o = typeof moment === "function"
                  ...
                  , k = function e(t) {
                    ...
                    if (t.showWeekNumber)
                        n.push("<th></th>");
                    for (i = 0; i < 7; i++)
                        n.push('<th scope="col"><abbr title="' + m(t, i) + '">' + m(t, i, true) + "</abbr></th>");
                    return "<thead><tr>" + (t.isRTL ? n.reverse() : n).join("") + "</tr></thead>"
                }
                  , w = function e(t, i, n, s, l, a) {
                    var o, r, h, c = t._o, d = n === c.minYear, u = n === c.maxYear, g = '<div id="' + a + '" class="pika-title" role="heading" aria-live="assertive">', v, f, p = true, m = true;
                    for (h = [],
                    o = 0; o < 12; o++)
                        h.push('<option value="' + (n === l ? o - i : 12 + o - i) + '"' + (o === s ? ' selected="selected"' : "") + (d && o < c.minMonth || u && o > c.maxMonth ? ' disabled="disabled"' : "") + ">" + c.i18n.months[o] + "</option>");
                    ...
                    for (h = []; o < r && o <= c.maxYear; o++)
                        if (o >= c.minYear)
                            h.push('<option value="' + o + '"' + (o === n ? ' selected="selected"' : "") + ">" + o + "</option>");
                    f = '<div class="pika-label">' + n + c.yearSuffix + '<select class="pika-select pika-select-year" tabindex="-1">' + h.join("") + "</select></div>";
                    if (c.showMonthAfterYear)
                        g += f + v;
                    else
                        g += v + f;
                    if (d && (s === 0 || c.minMonth >= s))
                        p = false;
                    if (u && (s === 11 || c.maxMonth <= s))
                        m = false;
                    if (i === 0)
                        g += '<button class="pika-prev' + (p ? "" : " is-disabled") + '" type="button">' + c.i18n.previousMonth + "</button>";
                    if (i === t._o.numberOfMonths - 1)
                        g += '<button class="pika-next' + (m ? "" : " is-disabled") + '" type="button">' + c.i18n.nextMonth + "</button>";
                    return g += "</div>"
                }
                  , V = function e(t, i, n) {
                  ...
                  , e = function e(t) {
                        ...
                        if (!r(t, "is-disabled"))
                            if (r(t, "pika-button") && !r(t, "is-empty") && !r(t.parentNode, "is-disabled")) {
                                ...
                                if (s.bound)
                                    c(function() {
                                        n.hide();
                                        if (s.blurFieldOnSelect && s.field)
                                            s.field.blur()
                                    }, 100)
                            } else if (r(t, "pika-prev"))
                                n.prevMonth();
                            else if (r(t, "pika-next"))
                                n.nextMonth();
                        if (!r(t, "pika-select"))
                            if (e.preventDefault)
                                e.preventDefault();
                    ...
                    n._onChange = function(e) {
                        ...
                        if (!t)
                            return;
                        if (r(t, "pika-select-month"))
                            n.gotoMonth(t.value);
                        else if (r(t, "pika-select-year"))
                            n.gotoYear(t.value)
                    }
                    ;
                    ...
                    n._onClick = function(e) {
                        ...
                        do {
                            if (r(i, "pika-single") || i === s.trigger)
                                return
                        } while (i = i.parentNode);
                        if (n._v && t !== s.trigger && i !== s.trigger)
                            n.hide()
                    }
                    ;
                    ...
                    if (s.keyboardInput)
                        a(g, "keydown", n._onKeyChange);
                    if (s.field) {
                        if (s.container)
                            s.container.appendChild(n.el);
                        else if (s.bound)
                            g.body.appendChild(n.el);
                        else
                            s.field.parentNode.insertBefore(n.el, s.field.nextSibling);
                ...
                return e.prototype = {
                    config: function e(t) {
                        ...
                        if (i.minDate)
                            this.setMinDate(i.minDate);
                        if (i.maxDate)
                            this.setMaxDate(i.maxDate);
                        if (b(i.yearRange)) {
                    ...
                    toString: function e(t) {
                        ...
                        if (!M(this._d))
                            return "";
                        if (this._o.toString)
                            return this._o.toString(this._d, t);
                        if (o)
                            return moment(this._d).format(t);
                    ...
                    setMoment: function e(t, i) {
                        if (o && moment.isMoment(t))
                            this.setDate(t.toDate(), i)
                    },
                    getDate: function e() {
                    ...
                    draw: function e(t) {
                        if (!this._v && !t)
                            return;
                        var i = this._o, n = i.minYear, s = i.maxYear, l = i.minMonth, a = i.maxMonth, o = "", r;
                        if (this._y <= n) {
                            this._y = n;
                            if (!isNaN(l) && this._m < l)
                                this._m = l
                        }
                        if (this._y >= s) {
                            this._y = s;
                            if (!isNaN(a) && this._m > a)
                                this._m = a
                        }
                        ...
                        if (typeof this._o.onDraw === "function")
                            this._o.onDraw(this);
                        if (i.bound)
                            i.field.setAttribute("aria-label", i.ariaLabel)
                    },
                    ...
                    render: function e(t, i, n) {
                        ...
                        for (var b = 0, y = 0; b < f; b++) {
                            ...
                            if (s.pickWholeWeek && k)
                                m = true;
                            h.push(F(D));
                            if (++y === 7) {
                                if (s.showWeekNumber)
                                    h.unshift(z(b - o, i, t, s.firstWeekOfYearMinDays));
      ...
      , f = function() {
        function i(e, t) {
            ...
            this.theme = a,
            this.yearRange = n,
            this.showDaysInNextAndPreviousMonths = l,
            this.enableSelectionDaysInNextAndPreviousMonths = i,
            this.reposition = t
        }
        ...
        i.prototype.init = function() {
            return new v({
                ...
                onOpen: function() {
                    ...
                    t.width >= e && (this.el.style.width = "auto",
                    this.el.style.right = t.left + "px")
                }
            })
        }
        ,
      ...
      , m = function() {
        ...
        i.autoInit = function(e, t) {
            t = (void 0 === t ? {} : t).BREADCRUMB_STANDARDISED,
            t = new i(e,void 0 === t ? {} : t);
            return t.init(),
      ...
      , b = function() {
        ...
        i.autoInit = function(e, t) {
            t = (void 0 === t ? {} : t).BREADCRUMB_HARMONISED,
            t = new i(e,void 0 === t ? {} : t);
            return t.init(),
      ...
      , y = function() {
        ...
        var e = i.prototype;
        return e.init = function() {
            if (this.toggle = r(this.toggleSelector, this.element),
    ...
    : Element.prototype.matches || Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector
      ...
      , A = function(e, t) {
        return !(t.disabled || d(i = t) && "hidden" === i.type || function(e, t) {
            ...
            return !1
        }(t, e.displayCheck) || "DETAILS" === (e = t).tagName && Array.prototype.slice.apply(e.children).some(function(e) {
    ...
    function N(n) {
        for (var e = 1; e < arguments.length; e++) {
            ...
            e % 2 ? M(Object(s), !0).forEach(function(e) {
                var t, i;
                t = n,
                e = s[i = e],
            ...
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(s)) : M(Object(s)).forEach(function(e) {
    ...
    function z(e, t) {
        ...
        function o(e) {
            ...
            if ("function" == typeof t) {
                for (var i = arguments.length, n = new Array(1 < i ? i - 1 : 0), s = 1; s < i; s++)
                    n[s - 1] = arguments[s];
                t = t.apply(void 0, n)
            }
            if (!t) {
            ...
            var l = t;
            if ("string" == typeof t && !(l = d.querySelector(t)))
                throw new Error("`".concat(e, "` as selector refers to no known node"));
            return l
        }
        function r() {
            if (g.tabbableGroups = g.containers.map(function(e) {
                var n, s, t = (n = [],
                s = [],
        ...
        function l() {
            return g.active && (V.activateTrap(y),
            g.delayInitialFocusTimer = u.delayInitialFocus ? B(function() {
                v(s())
            }) : v(s()),
        ...
        function c() {
            return g.active && (d.removeEventListener("focusin", f, !0),
            d.removeEventListener("mousedown", i, !0),
            d.removeEventListener("touchstart", i, !0),
            d.removeEventListener("click", b, !0),
            d.removeEventListener("keydown", m, !0),
            y)
        }
        var d = (null == t ? void 0 : t.document) || document
          ...
          , n = function(t) {
            return !(!t || !g.containers.some(function(e) {
                return e.contains(t)
            }))
        }
          , s = function() {
          ...
          , v = function e(t) {
            var i;
            !1 !== t && t !== d.activeElement && (t && t.focus ? (t.focus({
                preventScroll: !!u.preventScroll
            }),
            g.mostRecentlyFocusedNode = t,
            (i = t).tagName && "input" === i.tagName.toLowerCase() && "function" == typeof i.select && t.select()) : e(s()))
        }
          , i = function(e) {
            var t = F(e);
            n(t) || (P(u.clickOutsideDeactivates, e) ? y.deactivate({
          ...
          , f = function(e) {
            var t = F(e)
              , i = n(t);
            i || t instanceof Document ? i && (g.mostRecentlyFocusedNode = t) : (e.stopImmediatePropagation(),
            v(g.mostRecentlyFocusedNode || s()))
        }
          , p = function(e) {
            var t = F(e);
            r();
            var i, n, s, l = null;
            0 < g.tabbableGroups.length ? (i = R(g.tabbableGroups, function(e) {
                return e.container.contains(t)
            })) < 0 ? l = e.shiftKey ? g.tabbableGroups[g.tabbableGroups.length - 1].lastTabbableNode : g.tabbableGroups[0].firstTabbableNode : e.shiftKey ? 0 <= (n = (n = R(g.tabbableGroups, function(e) {
                e = e.firstTabbableNode;
                return t === e
            })) < 0 && (g.tabbableGroups[i].container === t || k(t) && !E(t)) ? i : n) && (s = 0 === n ? g.tabbableGroups.length - 1 : n - 1,
            l = g.tabbableGroups[s].lastTabbableNode) : 0 <= (s = (s = R(g.tabbableGroups, function(e) {
                e = e.lastTabbableNode;
                return t === e
            })) < 0 && (g.tabbableGroups[i].container === t || k(t) && !E(t)) ? i : s) && (s = s === g.tabbableGroups.length - 1 ? 0 : s + 1,
            l = g.tabbableGroups[s].firstTabbableNode) : l = o("fallbackFocus"),
            l && (e.preventDefault(),
            v(l))
        }
          , m = function(e) {
            if (("Escape" === (t = e).key || "Esc" === t.key || 27 === t.keyCode) && !1 !== P(u.escapeDeactivates, e))
                return e.preventDefault(),
                void y.deactivate();
            var t;
          ...
          , b = function(e) {
            var t;
            P(u.clickOutsideDeactivates, e) || (t = F(e),
            n(t) || P(u.allowOutsideClick, e) || (e.preventDefault(),
          ...
          , y = {
            activate: function(e) {
                ...
                g.active = !0,
                g.paused = !1,
                g.nodeFocusedBeforeActivation = d.activeElement,
                t && t();
                function s() {
                    n && r(),
                    l(),
                ...
                return n ? n(g.containers.concat()).then(s, s) : s(),
                this
            },
            deactivate: function(e) {
                ...
                function s() {
                    B(function() {
                        l && v(h(g.nodeFocusedBeforeActivation)),
                        i && i()
                    })
                }
                var l = a(e, "returnFocus", "returnFocusOnDeactivate");
                return l && n ? n(h(g.nodeFocusedBeforeActivation)).then(s, s) : s(),
                this
            },
            pause: function() {
                return g.paused || !g.active || (g.paused = !0,
                c()),
                this
            },
            unpause: function() {
                return g.paused && g.active && (g.paused = !1,
                r(),
                l()),
                this
            },
        ...
        return y.updateContainerElements(e),
        y
    }
    var H, V = (H = [],
    {
        ...
        e.updateOverlay = function(e) {
            var t, i = (this.selectedItem = e).getAttribute("data-ecl-gallery-item-embed-src"), n = r("video", e), s = null;
            null != i ? ((s = document.createElement("div")).classList.add("ecl-gallery__slider-embed"),
            (t = document.createElement("iframe")).setAttribute("src", i),
            t.setAttribute("frameBorder", "0"),
            this.overlayMedia && (s.appendChild(t),
            this.overlayMedia.innerHTML = "",
            this.overlayMedia.appendChild(s))) : null != n ? ((s = document.createElement("video")).setAttribute("poster", n.poster),
            ...
            null != i ? this.overlayDownload.hidden = !0 : (this.overlayDownload.href = this.selectedItem.href,
        ...
        !function(r, h) {
            ...
            var t, c = !1, i = void 0 !== r;
            i && r.getComputedStyle ? (t = h.createElement("div"),
            ...
            var s = (e(f, [{
                ...
                value: function() {
                    var e, t, i, n, s, l, a, o;
                    c || this._removed || (this._active && this._deactivate(),
                    e = this._node,
                    t = {
                    ...
                    isNaN(parseFloat(t.top)) || "table-cell" == t.display || "none" == t.display || (this._active = !0,
                    l = e.style.position,
            ...
            function m() {
                var e, t, i;
                function n() {
                    r.pageXOffset != a.left ? (a.top = r.pageYOffset,
                    a.left = r.pageXOffset,
                    p.refreshAll()) : r.pageYOffset != a.top && (a.top = r.pageYOffset,
                    a.left = r.pageXOffset,
                    o.forEach(function(e) {
                ...
                i = t = e = void 0,
                "hidden"in h ? (t = "hidden",
                i = "visibilitychange") : "webkitHidden"in h && (t = "webkitHidden",
            ...
            c || m(),
            b.exports ? b.exports = p : i && (r.Stickyfill = p)
        }(window, document)
    }), Y = c(function(e, t) {
        function i(e, t) {
            t = t || {
        ...
        u = function(e, t, i) {
            i.settings.events && (i = new CustomEvent(e,{
                bubbles: !0,
                cancelable: !0,
                detail: i
            }),
        ...
        ,
        a = function e(t, i) {
            i.nested && t.parentNode && ((t = t.parentNode.closest("li")) && (t.classList.remove(i.nestedClass),
            e(t, i)))
        }
        ,
        p = function(e, t) {
        ...
        ,
        m = function e(t, i) {
            !i.nested || (t = t.parentNode.closest("li")) && (t.classList.add(i.nestedClass),
            e(t, i))
        }
        ,
        function(e, t) {
            ...
            o.detect = function() {
                ...
                n ? l && n.content === l.content || (p(l, a),
                t = a,
                !(e = n) || (i = e.nav.closest("li")) && (i.classList.add(t.navClass),
            ...
            function r(e) {
                ...
                n = c.requestAnimationFrame(o.detect)
            }
            function h(e) {
                n && c.cancelAnimationFrame(n),
            ...
            o.destroy = function() {
                l && p(l, a),
                c.removeEventListener("scroll", r, !1),
                a.reflow && c.removeEventListener("resize", h, !1),
                a = n = l = i = s = null
            }
            ;
            return a = function() {
        ...
        i.autoInit = function(e, t) {
            t = (void 0 === t ? {} : t).INPAGE_NAVIGATION,
            t = new i(e,void 0 === t ? {} : t);
            return t.init(),
        ...
        e.initScrollSpy = function() {
            ...
            "IntersectionObserver"in window && ((e = r(this.containerSelector)) && (s = n = 0,
            l = !1,
            this.stickyObserver = new IntersectionObserver(function(e) {
                if (e && e[0]) {
                    ...
                    if (!l)
                        ...
                        n = i,
                        void (s = e);
                    i < n ? s < e && t || a.element.classList.remove(a.spyActiveContainer) : n < i && t && s < e && a.element.classList.add(a.spyActiveContainer),
                    n = i,
                    s = e
                }
            }
        ...
        e.handleClickOnToggler = function(e) {
            ...
            e ? t.classList.remove("ecl-inpage-navigation__list--visible") : t.classList.add("ecl-inpage-navigation__list--visible")
        }
        ,
            ...
            !function(s, d) {
                function l(e, t) {
                    ...
                    return this.getBrowser = function() {
                        ...
                        return m.rgx.call(e, i, n.browser),
                    ...
                    this.getDevice = function() {
                        ...
                        return m.rgx.call(e, i, n.device),
                        e
                    }
                    ,
                    this.getEngine = function() {
                        ...
                        return m.rgx.call(e, i, n.engine),
                        e
                    }
                    ,
                    this.getOS = function() {
                ...
                var u = "function"
                            ...
                            for (var r = t[o], h = t[o + 1], c = i = 0; c < r.length && !l; )
                                if (l = r[c++].exec(e))
                                    for (n = 0; n < h.length; n++)
                                        a = l[++i],
                                        "object" == typeof (s = h[n]) && 0 < s.length ? 2 == s.length ? typeof s[1] == u ? this[s[0]] = s[1].call(this, a) : this[s[0]] = s[1] : 3 == s.length ? typeof s[1] != u || s[1].exec && s[1].test ? this[s[0]] = a ? a.replace(s[1], s[2]) : d : this[s[0]] = a ? s[1].call(this, a, s[2]) : d : 4 == s.length && (this[s[0]] = a ? s[3].call(this, a.replace(s[1], s[2])) : d) : this[s] = a || d;
                            o += 2
                        }
                    },
                    str: function(e, t) {
                  ...
                  , y = {
                    ...
                    cpu: [[/(?:(amd|x(?:(?:86|64)[_-])?|wow|win)64)[;\)]/i], [[r, "amd64"]], [/(ia32(?=;))/i], [[r, p.lowerize]], [/((?:i[346]|x)86)[;\)]/i], [[r, "ia32"]], [/windows\s(ce|mobile);\sppc;/i], [[r, "arm"]], [/((?:ppc|powerpc)(?:64)?)(?:\smac|;|\))/i], [[r, /ower/, "", p.lowerize]], [/(sun4\w)[;\)]/i], [[r, "sparc"]], [/((?:avr32|ia64(?=;))|68k(?=\))|arm(?:64|(?=v\d+;))|(?=atmel\s)avr|(?:irix|mips|sparc)(?:64)?(?=;)|pa-risc)/i], [[r, p.lowerize]]],
                    device: [[/\((ipad|playbook);[\w\s\);-]+(rim|apple)/i], [t, a, [n, g]], [/applecoremedia\/[\w\.]+ \((ipad)/], [t, [a, "Apple"], [n, g]], [/(apple\s{0,1}tv)/i], [[t, "Apple TV"], [a, "Apple"]], [/(archos)\s(gamepad2?)/i, /(hp).+(touchpad)/i, /(hp).+(tablet)/i, /(kindle)\/([\w\.]+)/i, /\s(nook)[\w\s]+build\/(\w+)/i, /(dell)\s(strea[kpr\s\d]*[\dko])/i], [a, t, [n, g]], [/(kf[A-z]+)\sbuild\/.+silk\//i], [t, [a, "Amazon"], [n, g]], [/(sd|kf)[0349hijorstuw]+\sbuild\/.+silk\//i], [[t, m.str, b.device.amazon.model], [a, "Amazon"], [n, c]], [/\((ip[honed|\s\w*]+);.+(apple)/i], [t, a, [n, c]], [/\((ip[honed|\s\w*]+);/i], [t, [a, "Apple"], [n, c]], [/(blackberry)[\s-]?(\w+)/i, /(blackberry|benq|palm(?=\-)|sonyericsson|acer|asus|dell|meizu|motorola|polytron)[\s_-]?([\w-]*)/i, /(hp)\s([\w\s]+\w)/i, /(asus)-?(\w+)/i], [a, t, [n, c]], [/\(bb10;\s(\w+)/i], [t, [a, "BlackBerry"], [n, c]], [/android.+(transfo[prime\s]{4,10}\s\w+|eeepc|slider\s\w+|nexus 7|padfone)/i], [t, [a, "Asus"], [n, g]], [/(sony)\s(tablet\s[ps])\sbuild\//i, /(sony)?(?:sgp.+)\sbuild\//i], [[a, "Sony"], [t, "Xperia Tablet"], [n, g]], [/android.+\s([c-g]\d{4}|so[-l]\w+)\sbuild\//i], [t, [a, "Sony"], [n, c]], [/\s(ouya)\s/i, /(nintendo)\s([wids3u]+)/i], [a, t, [n, h]], [/android.+;\s(shield)\sbuild/i], [t, [a, "Nvidia"], [n, h]], [/(playstation\s[34portablevi]+)/i], [t, [a, "Sony"], [n, h]], [/(sprint\s(\w+))/i], [[a, m.str, b.device.sprint.vendor], [t, m.str, b.device.sprint.model], [n, c]], [/(lenovo)\s?(S(?:5000|6000)+(?:[-][\w+]))/i], [a, t, [n, g]], [/(htc)[;_\s-]+([\w\s]+(?=\))|\w+)*/i, /(zte)-(\w*)/i, /(alcatel|geeksphone|lenovo|nexian|panasonic|(?=;\s)sony)[_\s-]?([\w-]*)/i], [a, [t, /_/g, " "], [n, c]], [/(nexus\s9)/i], [t, [a, "HTC"], [n, g]], [/d\/huawei([\w\s-]+)[;\)]/i, /(nexus\s6p)/i], [t, [a, "Huawei"], [n, c]], [/(microsoft);\s(lumia[\s\w]+)/i], [a, t, [n, c]], [/[\s\(;](xbox(?:\sone)?)[\s\);]/i], [t, [a, "Microsoft"], [n, h]], [/(kin\.[onetw]{3})/i], [[t, /\./g, " "], [a, "Microsoft"], [n, c]], [/\s(milestone|droid(?:[2-4x]|\s(?:bionic|x2|pro|razr))?:?(\s4g)?)[\w\s]+build\//i, /mot[\s-]?(\w*)/i, /(XT\d{3,4}) build\//i, /(nexus\s6)/i], [t, [a, "Motorola"], [n, c]], [/android.+\s(mz60\d|xoom[\s2]{0,2})\sbuild\//i], [t, [a, "Motorola"], [n, g]], [/hbbtv\/\d+\.\d+\.\d+\s+\([\w\s]*;\s*(\w[^;]*);([^;]*)/i], [[a, p.trim], [t, p.trim], [n, v]], [/hbbtv.+maple;(\d+)/i], [[t, /^/, "SmartTV"], [a, "Samsung"], [n, v]], [/\(dtv[\);].+(aquos)/i], [t, [a, "Sharp"], [n, v]], [/android.+((sch-i[89]0\d|shw-m380s|gt-p\d{4}|gt-n\d+|sgh-t8[56]9|nexus 10))/i, /((SM-T\w+))/i], [[a, "Samsung"], t, [n, g]], [/smart-tv.+(samsung)/i], [a, [n, v], t], [/((s[cgp]h-\w+|gt-\w+|galaxy\snexus|sm-\w[\w\d]+))/i, /(sam[sung]*)[\s-]*(\w+-?[\w-]*)/i, /sec-((sgh\w+))/i], [[a, "Samsung"], t, [n, c]], [/sie-(\w*)/i], [t, [a, "Siemens"], [n, c]], [/(maemo|nokia).*(n900|lumia\s\d+)/i, /(nokia)[\s_-]?([\w-]*)/i], [[a, "Nokia"], t, [n, c]], [/android\s3\.[\s\w;-]{10}(a\d{3})/i], [t, [a, "Acer"], [n, g]], [/android.+([vl]k\-?\d{3})\s+build/i], [t, [a, "LG"], [n, g]], [/android\s3\.[\s\w;-]{10}(lg?)-([06cv9]{3,4})/i], [[a, "LG"], t, [n, g]], [/(lg) netcast\.tv/i], [a, t, [n, v]], [/(nexus\s[45])/i, /lg[e;\s\/-]+(\w*)/i, /android.+lg(\-?[\d\w]+)\s+build/i], [t, [a, "LG"], [n, c]], [/android.+(ideatab[a-z0-9\-\s]+)/i], [t, [a, "Lenovo"], [n, g]], [/linux;.+((jolla));/i], [a, t, [n, c]], [/((pebble))app\/[\d\.]+\s/i], [a, t, [n, f]], [/android.+;\s(oppo)\s?([\w\s]+)\sbuild/i], [a, t, [n, c]], [/crkey/i], [[t, "Chromecast"], [a, "Google"]], [/android.+;\s(glass)\s\d/i], [t, [a, "Google"], [n, f]], [/android.+;\s(pixel c)\s/i], [t, [a, "Google"], [n, g]], [/android.+;\s(pixel xl|pixel)\s/i], [t, [a, "Google"], [n, c]], [/android.+;\s(\w+)\s+build\/hm\1/i, /android.+(hm[\s\-_]*note?[\s_]*(?:\d\w)?)\s+build/i, /android.+(mi[\s\-_]*(?:one|one[\s_]plus|note lte)?[\s_]*(?:\d?\w?)[\s_]*(?:plus)?)\s+build/i, /android.+(redmi[\s\-_]*(?:note)?(?:[\s_]*[\w\s]+))\s+build/i], [[t, /_/g, " "], [a, "Xiaomi"], [n, c]], [/android.+(mi[\s\-_]*(?:pad)(?:[\s_]*[\w\s]+))\s+build/i], [[t, /_/g, " "], [a, "Xiaomi"], [n, g]], [/android.+;\s(m[1-5]\snote)\sbuild/i], [t, [a, "Meizu"], [n, g]], [/android.+a000(1)\s+build/i, /android.+oneplus\s(a\d{4})\s+build/i], [t, [a, "OnePlus"], [n, c]], [/android.+[;\/]\s*(RCT[\d\w]+)\s+build/i], [t, [a, "RCA"], [n, g]], [/android.+[;\/\s]+(Venue[\d\s]{2,7})\s+build/i], [t, [a, "Dell"], [n, g]], [/android.+[;\/]\s*(Q[T|M][\d\w]+)\s+build/i], [t, [a, "Verizon"], [n, g]], [/android.+[;\/]\s+(Barnes[&\s]+Noble\s+|BN[RT])(V?.*)\s+build/i], [[a, "Barnes & Noble"], t, [n, g]], [/android.+[;\/]\s+(TM\d{3}.*\b)\s+build/i], [t, [a, "NuVision"], [n, g]], [/android.+;\s(k88)\sbuild/i], [t, [a, "ZTE"], [n, g]], [/android.+[;\/]\s*(gen\d{3})\s+build.*49h/i], [t, [a, "Swiss"], [n, c]], [/android.+[;\/]\s*(zur\d{3})\s+build/i], [t, [a, "Swiss"], [n, g]], [/android.+[;\/]\s*((Zeki)?TB.*\b)\s+build/i], [t, [a, "Zeki"], [n, g]], [/(android).+[;\/]\s+([YR]\d{2})\s+build/i, /android.+[;\/]\s+(Dragon[\-\s]+Touch\s+|DT)(\w{5})\sbuild/i], [[a, "Dragon Touch"], t, [n, g]], [/android.+[;\/]\s*(NS-?\w{0,9})\sbuild/i], [t, [a, "Insignia"], [n, g]], [/android.+[;\/]\s*((NX|Next)-?\w{0,9})\s+build/i], [t, [a, "NextBook"], [n, g]], [/android.+[;\/]\s*(Xtreme\_)?(V(1[045]|2[015]|30|40|60|7[05]|90))\s+build/i], [[a, "Voice"], t, [n, c]], [/android.+[;\/]\s*(LVTEL\-)?(V1[12])\s+build/i], [[a, "LvTel"], t, [n, c]], [/android.+[;\/]\s*(V(100MD|700NA|7011|917G).*\b)\s+build/i], [t, [a, "Envizen"], [n, g]], [/android.+[;\/]\s*(Le[\s\-]+Pan)[\s\-]+(\w{1,9})\s+build/i], [a, t, [n, g]], [/android.+[;\/]\s*(Trio[\s\-]*.*)\s+build/i], [t, [a, "MachSpeed"], [n, g]], [/android.+[;\/]\s*(Trinity)[\-\s]*(T\d{3})\s+build/i], [a, t, [n, g]], [/android.+[;\/]\s*TU_(1491)\s+build/i], [t, [a, "Rotor"], [n, g]], [/android.+(KS(.+))\s+build/i], [t, [a, "Amazon"], [n, g]], [/android.+(Gigaset)[\s\-]+(Q\w{1,9})\s+build/i], [a, t, [n, g]], [/\s(tablet|tab)[;\/]/i, /\s(mobile)(?:[;\/]|\ssafari)/i], [[n, p.lowerize], a, t], [/(android[\w\.\s\-]{0,9});.+build/i], [t, [a, "Generic"]]],
                ...
                typeof S != e ? (S = typeof w != e && w.exports ? w.exports = l : S).UAParser = l : C(3) ? (L = function() {
                    return l
                }
                .call(S, C, S, w)) === d || (w.exports = L) : s && (s.UAParser = l);
                var E, k = s && (s.jQuery || s.Zepto);
                typeof k != e && (E = new l,
                k.ua = E.getResult(),
                k.ua.get = function() {
                    return E.getUA()
        ...
        n.p = "",
        n(n.s = 1))
    }), q = (ee = X) && ee.__esModule && Object.prototype.hasOwnProperty.call(ee, "default") ? ee.default : ee, K = function() {
        function i(e, t) {
            var i = void 0 === t ? {} : t
              , n = i.openSelector
        ...
        return e.init = function() {
            ...
            this.attachResizeListener && window.addEventListener("resize", this.handleResize),
            this.items && !q.isMobile && this.items.forEach(function(e) {
                t.checkMenuItem(e),
                e.hasAttribute("data-ecl-has-children") && (t.attachHoverListener && (e.addEventListener("mouseover", t.handleHoverOnItem),
                e.addEventListener("mouseout", t.handleHoverOffItem)),
                t.attachFocusListener && (e.addEventListener("focusin", t.handleHoverOnItem),
                e.addEventListener("focusout", t.handleHoverOffItem)))
            }),
            this.stickyInstance = new j.Sticky(this.element),
            setTimeout(function() {
        ...
        e.destroy = function() {
            ...
            this.items && !q.isMobile && this.items.forEach(function(e) {
                e.hasAttribute("data-ecl-has-children") && (t.attachHoverListener && (e.removeEventListener("mouseover", t.handleHoverOnItem),
                e.removeEventListener("mouseout", t.handleHoverOffItem)),
                t.attachFocusListener && (e.removeEventListener("focusin", t.handleHoverOnItem),
                e.removeEventListener("focusout", t.handleHoverOffItem)))
            }),
            this.attachClickListener && this.links && this.links.forEach(function(e) {
        ...
        e.useDesktopDisplay = function() {
            return !q.isMobileOnly && (q.isTablet ? (this.element.classList.add("ecl-menu--forced-mobile"),
        ...
        e.handleResize = function() {
            ...
            this.resizeTimer = setTimeout(function() {
                ...
                t.useDesktopDisplay(),
                t.items && !q.isMobile && t.items.forEach(function(e) {
                    t.checkMenuItem(e)
                }),
                t.element.classList.add("ecl-menu--transition")
            }, 200),
        ...
        e.checkMenuItem = function(e) {
            ...
            if (t) {
                ...
                if (i.length < 5)
                    ...
                    if (!(i.length < 13))
                        return void e.classList.add("ecl-menu__item--full");
        ...
        e.handleHoverOffItem = function(e) {
            return e.target.closest("[data-ecl-menu-item]").setAttribute("aria-expanded", "false"),
            this
        }
        ,
        i
        ...
        ,
        e.shiftSlide = function(e, t) {
            this.allowShift && (this.index = 1 === e ? this.index + 1 : this.index - 1,
            this.moveSlides(!0)),
            t && this.autoPlay && this.handleClickOnToggle(),
            this.allowShift = !1
        }
        ...
        c.createCheckbox = function(e, t) {
            ...
            e.appendChild(c.createSvgIcon('<svg width="48" height="48" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path id="a" d="M36 12 20 28l-8-8-4 4 12 12 20-20z"/></defs><use xlink:href="#a"/></svg>', "ecl-icon ecl-icon--s ecl-checkbox__icon")),
            h.appendChild(e),
        ...
        c.createSelectIcon = function() {
            ...
            var t = c.createSvgIcon('<svg width="48" height="48" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><defs><path id="a" d="M40 38 24 20 8 38l-6-6L24 8l22 24z"/></defs><use xlink:href="#a"/></svg>', "ecl-icon ecl-icon--s ecl-select__icon-shape ecl-icon--rotate-180");
        ...
        return e.init = function() {
            ...
            this.textSelectAll && (this.selectAll = c.createCheckbox({
                id: "all",
            ...
            this.select.options && 0 < this.select.options.length && (this.checkboxes = Array.from(this.select.options).map(function(e) {
                ...
                return e.setAttribute("data-visible", !0),
                e.classList.contains("ecl-checkbox--disabled") || (e.addEventListener("click", t.handleClickOption),
                e.addEventListener("keypress", t.handleClickOption)),
        ...
        e.handleClickSelectAll = function(e) {
            var i, n;
            e.preventDefault(),
            this.selectAll.querySelector("input").disabled || (i = c.checkCheckbox(e),
        ...
        e.handleSearch = function(e) {
            ...
            this.checkboxes.forEach(function(e) {
                var t, i;
                e.getAttribute("data-select-multiple-value").toLocaleLowerCase().includes(s) ? (e.setAttribute("data-visible", !0),
                ...
                n.push(e)) : (e.setAttribute("data-visible", !1),
            ...
            0 !== n.length || e ? 0 < n.length && null !== e && e.parentNode.removeChild(e) : (t = document.createElement("div"),
            e = document.createElement("span"),
            t.classList.add("ecl-select__multiple-no-results"),
            e.innerHTML = this.textNoResults,
            t.appendChild(e),
            this.optionsContainer.appendChild(t)),
            0 === s.length ? (this.checkboxes.forEach(function(e) {
                e.setAttribute("data-visible", !0),
                e.style.display = "flex"
            }),
            this.selectAll.classList.remove("ecl-checkbox--disabled"),
            this.selectAll.querySelector("input").disabled = !1) : (this.selectAll.classList.add("ecl-checkbox--disabled"),
        ...
        n.createSortIcon = function(e) {
            ...
            t = t.children[0];
            return t.removeAttribute("height"),
        ...
        e.handleClickOnSort = function(t) {
            for (var e = t.closest("table"), i = r("tbody", e), n = t.getAttribute("aria-sort"), s = 0, l = t.previousElementSibling; l; )
                s += l.getAttribute("colspan") ? Number(l.getAttribute("colspan")) : 1,
                l = l.previousElementSibling;
            function a(n, s) {
                return function(e, t) {
                    return i = (s ? e : t).children[n].textContent,
                    e = (s ? t : e).children[n].textContent,
                    "" === i || "" === e || Number.isNaN(+i) || Number.isNaN(+e) ? i.toString().localeCompare(e) : i - e;
                    var i
                }
            }
        ...
        return e.init = function() {
            ...
            this.moreButton && (this.dropdown = document.createElement("ul"),
        ...
        e.shiftTabs = function(e) {
            ...
            t < e && (this.btnNext.style.display = "none",
            e = t),
        ...
        e.handleClickOnToggle = function() {
            ...
            this.moreButton.setAttribute("aria-expanded", this.dropdown.classList.contains("ecl-tabs__dropdown--show"))
        }
        ,
        e.handleResize = function() {
            var i = this;
            if ("none" === window.getComputedStyle(this.moreButton).display && this.closeMoreDropdown(this),
            ...
            Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0) <= 480) {
                ...
                var t = 0;
                return this.listItems.forEach(function(e) {
            ...
            this.listItems.forEach(function(e, t) {
                e.setAttribute("aria-hidden", "false"),
                l >= n + e.getBoundingClientRect().width && !s.includes(t - 1) ? n += e.getBoundingClientRect().width : (e.setAttribute("aria-hidden", "true"),
                e.childNodes[0].classList.contains("ecl-tabs__link--active") && (i.moreButtonActive = !0),
                s.push(t))
            }),
            ...
            s.length ? (this.moreItem.setAttribute("aria-hidden", "false"),
        ...
        var e = i.prototype;
        return e.init = function() {
            this.button = r(this.buttonSelector, this.element),
            this.label = r(this.labelSelector, this.element),
    ...
    e.autoInit = function(e) {
        var t = void 0 === e ? {} : e
          ...
          , n = function(e, t) {
            if (null == e)
                return {};
            for (var i, n = {}, s = Object.keys(e), l = 0; l < s.length; l++)
                i = s[l],
