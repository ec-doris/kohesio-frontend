...
import { MapMessageBoxComponent } from '../map/map-message-box';
import { MapPopupComponent } from '../map/map-popup.component';
...
@Component({
  ...
  styleUrl: './map-region.component.scss'
})
export class MapRegionComponent implements AfterViewInit {
